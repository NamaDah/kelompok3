...
username.addEventListener("input", function(){
    if (username.value.length < 4) {
        ...
        usernameError.textContent = "*Username harus kurang dari 20.";
    }else {
...
password.addEventListener("input", function(){
    if (password.value.length < 8) {
        passwordError.textContent = "*Password harus terdiri dari 8 karakter."
    }else if(password.value.length > 20){
        passwordError.textContent = "*Password harus kurang dari 20 karakter."
    }else {
